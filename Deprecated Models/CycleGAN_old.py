...
def train_step(real_x, real_y, step, 
               ...
               generator_f=None, discriminator_y=None, generator_f_optimizer=None, discriminator_y_optimizer=None, 
  ...
  with tf.GradientTape(persistent=True) as tape:
    ...
    if step % 20 == 0:
        with train_summary_writer.as_default():
          tf.summary.scalar('total_gen_g_loss', total_gen_g_loss, step=step)
          tf.summary.scalar('total_gen_f_loss', total_gen_f_loss, step=step)
            
          tf.summary.scalar('disc_x_loss', disc_x_loss, step=step)
          tf.summary.scalar('disc_y_loss', disc_y_loss, step=step)
